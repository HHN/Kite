...
{
    public class SoundSettingsSceneController : SceneController
    {
        ...
        private void Start()
        {
            BackStackManager.Instance().Push(SceneNames.SoundSettingsScene);
        ...
        {
            bool isSoundEffectVolumeOn = UnityEngine.PlayerPrefs.GetInt("IsSoundEffectVolumeOn", 1) == 1;
            if (!isSoundEffectVolumeOn)
            {
            ...
            else
            {
                ...
                _soundEffectVolume = UnityEngine.PlayerPrefs.GetFloat("SavedSoundEffectVolume", 1);
            }
        }
        ...
        {
            UnityEngine.PlayerPrefs.SetFloat("SavedSoundEffectVolume", value);
            ...
            {
                toggleSoundEffects.isOn = true;
                UnityEngine.PlayerPrefs.SetInt("IsSoundEffectVolumeOn", 1);
            }
            else
            {
                toggleSoundEffects.isOn = false;
                UnityEngine.PlayerPrefs.SetInt("IsSoundEffectVolumeOn", 0);
            }
        }
        ...
        private void OnToggleSoundEffects()
        {
            ...
            {
                UnityEngine.PlayerPrefs.SetFloat("SavedSoundEffectVolume", _soundEffectVolume);
            ...
            {                    
                _soundEffectVolume = UnityEngine.PlayerPrefs.GetFloat("SavedSoundEffectVolume");
