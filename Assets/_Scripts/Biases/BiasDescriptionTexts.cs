...
namespace Assets._Scripts.Biases
{
    public static class BiasDescriptionTexts
    {
        ...
        public static string GetBiasText(BiasType biasType)
        {
            ...
            if (_biasDetails != null && _biasDetails.TryGetValue(biasType, out var biasInfo))
            {
                string finalDescription = biasInfo.description.Replace("=LINK_COLOR", $"={LinkColor}");
        ...
        //
        // private static readonly string FinanzierungszugangHeadline = "Access To Funding";
        //
