    ...
    public abstract class KiteNovelConverter
    {
        ...
        public static List<VisualNovel> ConvertFilesToNovels(List<KiteNovelFolder> folders)
        {
            ...
            foreach (KiteNovelFolder folder in folders)
            {
                ...
                novel.id = folder.NovelMetaData.ID;
        ...
        public static KiteNovelEventList ConvertTextDocumentIntoEventList(string tweeFile, NovelMetaData kiteNovelMetaData)
        {
        ...
        private static void InitializeKiteNovelEventList(NovelMetaData kiteNovelMetaData, KiteNovelEventList kiteNovelEventList, string startLabel)
        {
            string connectionLabel = "initalCharakterJoinsEvent001"; // Typo????
            string id = "initialLocationEvent001";
            string nextId = connectionLabel;

            id = connectionLabel;
            nextId = startLabel;
            CharacterRole character = CharacterTypeHelper.ValueOf(kiteNovelMetaData.TalkingPartners[0]);
            ...
            int faceExpression = FaceExpressionHelper.ToInt(kiteNovelMetaData.StartTalkingPartnerEmotion);
            CharacterExpression expression = CharacterExpressionHelper.ValueOf(faceExpression);
        ...
        private static VisualNovelEvent CreateVisualNovelEvents(TweePassage passage, NovelMetaData kiteNovelMetaData, KiteNovelEventList kiteNovelEventList)
        {
        ...
        private static VisualNovelEvent CreateOneVisualNovelEvent(TweePassage passage,
            NovelMetaData kiteNovelMetaData, KiteNovelEventList kiteNovelEventList)
        {
        ...
        private static VisualNovelEvent CreateMultipleVisualNovelEvent(TweePassage passage, NovelMetaData kiteNovelMetaData, KiteNovelEventList kiteNovelEventList)
        {
            ...
            foreach (string eventDefinition in eventDefinitions)
            {
                ...
                VisualNovelEvent visualNovelEvent = ConvertListOfDataObjectsIntoKiteNovelEvent(newPassage, message, kiteNovelMetaData,
                        kiteNovelEventList);
        ...
        private static VisualNovelEvent ConvertListOfDataObjectsIntoKiteNovelEvent(TweePassage passage, string message, NovelMetaData kiteNovelMetaData, KiteNovelEventList kiteNovelEventList)
        {
            ...
            CharacterRole character01 = CharacterTypeHelper.ValueOf(kiteNovelMetaData.TalkingPartners[0]);
            CharacterRole character02 = CharacterTypeHelper.ValueOf(kiteNovelMetaData.TalkingPartners[1]);
            CharacterRole character03 = CharacterTypeHelper.ValueOf(kiteNovelMetaData.TalkingPartners[2]);
            ...
            switch (recognizedKeyWord)
            {
                ...
                {
                    return HandlePlayAnimationEvent(passage, KiteAnimation.WaterPouring, kiteNovelEventList.NovelEvents);
                }
