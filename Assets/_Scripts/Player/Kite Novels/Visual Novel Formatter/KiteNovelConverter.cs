...
namespace Assets._Scripts.Player.Kite_Novels.Visual_Novel_Formatter
{
    public abstract class KiteNovelConverter
    {
            ...
            CompletionHandler completionHandlerId, List<VisualNovelEvent> list)
        {
            ...
            if (parts.Length != 2)
            {
                Debug.LogWarning("While creating Visual Novel: GPT Prompt Event could not be created.");
                return null;
            }
            ...
            List<VisualNovelEvent> list)
        {
            ...
            if (parts.Length != 2)
            {
                Debug.LogWarning("While creating Visual Novel: Save Persistent Event could not be created.");
                return null;
            }
            ...
            List<VisualNovelEvent> list)
        {
            ...
            if (parts.Length != 2)
            {
                Debug.LogWarning("While creating Visual Novel: Save Variable Event could not be created.");
                return null;
            }
            ...
            List<VisualNovelEvent> list)
        {
            ...
            {
                Debug.LogWarning(
                    "While creating Visual Novel: Calculate Variable from boolean expression Event could not be created.");
                return null;
            }
            ...
            List<VisualNovelEvent> list)
        {
            ...
            {
                Debug.LogWarning(
                    "While creating Visual Novel: Add Feedback Under Condition Event could not be created.");
                return null;
            }
