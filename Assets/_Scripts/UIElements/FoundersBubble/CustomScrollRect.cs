...
namespace Assets._Scripts.UIElements.Founders_Bubble
{
    ...
    {
        [SerializeField] private InfinityScroll novels;
        public PointerEventData LastDragBegin;
        ...
        /// <summary>
        /// The sensitivity to scroll wheel and trackpad scroll events.
        /// </summary>
        /// <remarks>
...
#pragma warning restore 649
        ...
        protected virtual void SetContentAnchoredPosition(Vector2 position)
        {
            ...
            Vector2 positionChange = position - m_Content.anchoredPosition;
            ...
            novels.CalculateAndSetCurrentPositionForSecondScrollView(positionChange);
        }
            ...
            if (deltaTime > 0.0f)
            {
                if (!m_Dragging && (offset != Vector2.zero || m_Velocity != Vector2.zero))
                {
                    ...
                    for (int axis = 0; axis < 2; axis++)
                    {
                        ...
                        // If we have neither elasticity nor friction, there shouldn't be any velocity.
                        else
                        {
                            m_Velocity[axis] = 0;
                        }
        ...
        public virtual void SetLayoutHorizontal()
        {
            ...
            if (m_VSliderExpand && vScrollingNeeded)
            {
                ...
                // when there is a vertical scrollbar (which may overflow the content to make it taller).
                LayoutRebuilder.ForceRebuildLayoutImmediate(content);
                m_ViewBounds = new Bounds(viewRect.rect.center, viewRect.rect.size);
                m_ContentBounds = GetBounds();
            }
