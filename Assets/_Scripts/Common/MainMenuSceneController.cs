...
namespace Assets._Scripts.Common
{
    public class MainMenuSceneController : SceneController, IOnSuccessHandler
    {
        ...
        private void Start()
        {
            ...
            if (UnityEngine.PlayerPrefs.GetInt("IsSoundeffectsVolumeOn", 1) == 1)
            {
                GlobalVolumeManager.Instance.SetGlobalVolume(UnityEngine.PlayerPrefs.GetFloat("SavedSoundeffectsVolume", 1));
            }
            else
            {
