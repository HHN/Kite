...
namespace Assets._Scripts.Novels.Visual_Novel_Formatter
{
    public class NovelTester
    {
        ...
        private void TestNovel(VisualNovel novelToTest)
        {
            ...
            {
                OnTestFailed("Novels under test is null.", "-", "-");
                return;
            }
            ...
            {
                OnTestFailed("Novels title is null or empty.", "-", "-");
                return;
            }
        ...
        private void TestEndedEarly()
        {
            if (_isOriginalTest)
            {
                Debug.LogError("Finished Test of Novels with Errors. Novels under Test: " + _objectUnderTest.title + ";");
            }
            else
            {
