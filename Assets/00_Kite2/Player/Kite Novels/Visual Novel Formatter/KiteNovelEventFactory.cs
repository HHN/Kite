...
{      
    ...
    public static VisualNovelEvent GetCharacterTalksEvent(string id, string nextId, Character character, string dialogMessage, CharacterExpression expression)
    {
        VisualNovelEvent novelEvent = CreateEvent(id, nextId, VisualNovelEventType.SHOW_MESSAGE_EVENT, true);
        novelEvent.character = CharacterTypeHelper.ToInt(character);
    ...
    public static VisualNovelEvent GetCharacterJoinsEvent(string id, string nextId, Character character, CharacterExpression expression)
    {
    ...
    public static VisualNovelEvent GetGptEvent(string id, string nextId, string prompt, string variablesName, CompletionHandler completionHandlerId)
    {
