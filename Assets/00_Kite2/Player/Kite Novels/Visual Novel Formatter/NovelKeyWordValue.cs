...
public class NovelKeyWordValue
{
    ...
    public const string EINTRITT_CHARAKTER_01_GESICHTSAUSDRUCK_RELAXED = ">>Eintritt:Charakter01,Gesichtsausdruck:relaxed<<";
    public const string EINTRITT_CHARAKTER_01_GESICHTSAUSDRUCK_ASTONISHED = ">>Eintritt:Charakter01,Gesichtsausdruck:astonished<<";
    public const string EINTRITT_CHARAKTER_01_GESICHTSAUSDRUCK_REFUSING = ">>Eintritt:Charakter01,Gesichtsausdruck:refusing<<";
    public const string EINTRITT_CHARAKTER_01_GESICHTSAUSDRUCK_SMILING = ">>Eintritt:Charakter01,Gesichtsausdruck:smiling<<";
    public const string EINTRITT_CHARAKTER_01_GESICHTSAUSDRUCK_FRIENDLY = ">>Eintritt:Charakter01,Gesichtsausdruck:friendly<<";
    public const string EINTRITT_CHARAKTER_01_GESICHTSAUSDRUCK_LAUGHING = ">>Eintritt:Charakter01,Gesichtsausdruck:laughing<<";
    public const string EINTRITT_CHARAKTER_01_GESICHTSAUSDRUCK_CRITICAL = ">>Eintritt:Charakter01,Gesichtsausdruck:critical<<";
    public const string EINTRITT_CHARAKTER_01_GESICHTSAUSDRUCK_DECISION_NO = ">>Eintritt:Charakter01,Gesichtsausdruck:decisionNo<<";
    public const string EINTRITT_CHARAKTER_01_GESICHTSAUSDRUCK_HAPPY = ">>Eintritt:Charakter01,Gesichtsausdruck:happy<<";
    public const string EINTRITT_CHARAKTER_01_GESICHTSAUSDRUCK_PROUD = ">>Eintritt:Charakter01,Gesichtsausdruck:proud<<";
    public const string EINTRITT_CHARAKTER_01_GESICHTSAUSDRUCK_SCARED = ">>Eintritt:Charakter01,Gesichtsausdruck:scared<<";
    public const string EINTRITT_CHARAKTER_01_GESICHTSAUSDRUCK_QUESTIONING = ">>Eintritt:Charakter01,Gesichtsausdruck:questioning<<";
    public const string EINTRITT_CHARAKTER_01_GESICHTSAUSDRUCK_DEFEATED = ">>Eintritt:Charakter01,Gesichtsausdruck:defeated<<";
    ...
    public const string CHARAKTER_SPRICHT_CHARAKTER_01_GESICHTSAUSDRUCK_ASTONISHED = ">>Charakter01SprichtAstonished:<<";
    public const string CHARAKTER_SPRICHT_CHARAKTER_01_GESICHTSAUSDRUCK_REFUSING = ">>Charakter01SprichtRefusing:<<";
    public const string CHARAKTER_SPRICHT_CHARAKTER_01_GESICHTSAUSDRUCK_SMILING = ">>Charakter01SprichtSmiling:<<";
    public const string CHARAKTER_SPRICHT_CHARAKTER_01_GESICHTSAUSDRUCK_FRIENDLY = ">>Charakter01SprichtFriendly:<<";
    public const string CHARAKTER_SPRICHT_CHARAKTER_01_GESICHTSAUSDRUCK_LAUGHING = ">>Charakter01SprichtLaughing:<<";
    public const string CHARAKTER_SPRICHT_CHARAKTER_01_GESICHTSAUSDRUCK_CRITICAL = ">>Charakter01SprichtCritical:<<";
    public const string CHARAKTER_SPRICHT_CHARAKTER_01_GESICHTSAUSDRUCK_DECISION_NO = ">>Charakter01SprichtDecisionNo:<<";
    ...
    public const string CHARAKTER_SPRICHT_CHARAKTER_01_GESICHTSAUSDRUCK_QUESTIONING = ">>Charakter01SprichtQuestioning:<<";
    public const string CHARAKTER_SPRICHT_CHARAKTER_01_GESICHTSAUSDRUCK_DEFEATED = ">>Charakter01SprichtDefeated:<<";

    public const string EINTRITT_CHARAKTER_02 = ">>Eintritt:Charakter02<<";
    public const string EINTRITT_CHARAKTER_02_GESICHTSAUSDRUCK_RELAXED = ">>Eintritt:Charakter02,Gesichtsausdruck:relaxed<<";
    public const string EINTRITT_CHARAKTER_02_GESICHTSAUSDRUCK_ASTONISHED = ">>Eintritt:Charakter02,Gesichtsausdruck:astonished<<";
    public const string EINTRITT_CHARAKTER_02_GESICHTSAUSDRUCK_REFUSING = ">>Eintritt:Charakter02,Gesichtsausdruck:refusing<<";
    public const string EINTRITT_CHARAKTER_02_GESICHTSAUSDRUCK_SMILING = ">>Eintritt:Charakter02,Gesichtsausdruck:smiling<<";
    public const string EINTRITT_CHARAKTER_02_GESICHTSAUSDRUCK_FRIENDLY = ">>Eintritt:Charakter02,Gesichtsausdruck:friendly<<";
    public const string EINTRITT_CHARAKTER_02_GESICHTSAUSDRUCK_LAUGHING = ">>Eintritt:Charakter02,Gesichtsausdruck:laughing<<";
    public const string EINTRITT_CHARAKTER_02_GESICHTSAUSDRUCK_CRITICAL = ">>Eintritt:Charakter02,Gesichtsausdruck:critical<<";
    public const string EINTRITT_CHARAKTER_02_GESICHTSAUSDRUCK_DECISION_NO = ">>Eintritt:Charakter02,Gesichtsausdruck:decisionNo<<";
    public const string EINTRITT_CHARAKTER_02_GESICHTSAUSDRUCK_HAPPY = ">>Eintritt:Charakter02,Gesichtsausdruck:happy<<";
    public const string EINTRITT_CHARAKTER_02_GESICHTSAUSDRUCK_PROUD = ">>Eintritt:Charakter02,Gesichtsausdruck:proud<<";
    public const string EINTRITT_CHARAKTER_02_GESICHTSAUSDRUCK_SCARED = ">>Eintritt:Charakter02,Gesichtsausdruck:scared<<";
    public const string EINTRITT_CHARAKTER_02_GESICHTSAUSDRUCK_QUESTIONING = ">>Eintritt:Charakter02,Gesichtsausdruck:questioning<<";
    public const string EINTRITT_CHARAKTER_02_GESICHTSAUSDRUCK_DEFEATED = ">>Eintritt:Charakter02,Gesichtsausdruck:defeated<<";
    ...
    public const string CHARAKTER_SPRICHT_CHARAKTER_02_GESICHTSAUSDRUCK_ASTONISHED = ">>Charakter02SprichtAstonished:<<";
    public const string CHARAKTER_SPRICHT_CHARAKTER_02_GESICHTSAUSDRUCK_REFUSING = ">>Charakter02SprichtRefusing:<<";
    public const string CHARAKTER_SPRICHT_CHARAKTER_02_GESICHTSAUSDRUCK_SMILING = ">>Charakter02SprichtSmiling:<<";
    public const string CHARAKTER_SPRICHT_CHARAKTER_02_GESICHTSAUSDRUCK_FRIENDLY = ">>Charakter02SprichtFriendly:<<";
    public const string CHARAKTER_SPRICHT_CHARAKTER_02_GESICHTSAUSDRUCK_LAUGHING = ">>Charakter02SprichtLaughing:<<";
    public const string CHARAKTER_SPRICHT_CHARAKTER_02_GESICHTSAUSDRUCK_CRITICAL = ">>Charakter02SprichtCritical:<<";
    public const string CHARAKTER_SPRICHT_CHARAKTER_02_GESICHTSAUSDRUCK_DECISION_NO = ">>Charakter02SprichtDecisionNo:<<";
    ...
    public const string CHARAKTER_SPRICHT_CHARAKTER_02_GESICHTSAUSDRUCK_QUESTIONING = ">>Charakter02SprichtQuestioning:<<";
    public const string CHARAKTER_SPRICHT_CHARAKTER_02_GESICHTSAUSDRUCK_DEFEATED = ">>Charakter02SprichtDefeated:<<";

    public const string EINTRITT_CHARAKTER_03 = ">>Eintritt:Charakter03<<";
    public const string EINTRITT_CHARAKTER_03_GESICHTSAUSDRUCK_RELAXED = ">>Eintritt:Charakter03,Gesichtsausdruck:relaxed<<";
    public const string EINTRITT_CHARAKTER_03_GESICHTSAUSDRUCK_ASTONISHED = ">>Eintritt:Charakter03,Gesichtsausdruck:astonished<<";
    public const string EINTRITT_CHARAKTER_03_GESICHTSAUSDRUCK_REFUSING = ">>Eintritt:Charakter03,Gesichtsausdruck:refusing<<";
    public const string EINTRITT_CHARAKTER_03_GESICHTSAUSDRUCK_SMILING = ">>Eintritt:Charakter03,Gesichtsausdruck:smiling<<";
    public const string EINTRITT_CHARAKTER_03_GESICHTSAUSDRUCK_FRIENDLY = ">>Eintritt:Charakter03,Gesichtsausdruck:friendly<<";
    public const string EINTRITT_CHARAKTER_03_GESICHTSAUSDRUCK_LAUGHING = ">>Eintritt:Charakter03,Gesichtsausdruck:laughing<<";
    public const string EINTRITT_CHARAKTER_03_GESICHTSAUSDRUCK_CRITICAL = ">>Eintritt:Charakter03,Gesichtsausdruck:critical<<";
    public const string EINTRITT_CHARAKTER_03_GESICHTSAUSDRUCK_DECISION_NO = ">>Eintritt:Charakter03,Gesichtsausdruck:decisionNo<<";
    public const string EINTRITT_CHARAKTER_03_GESICHTSAUSDRUCK_HAPPY = ">>Eintritt:Charakter03,Gesichtsausdruck:happy<<";
    public const string EINTRITT_CHARAKTER_03_GESICHTSAUSDRUCK_PROUD = ">>Eintritt:Charakter03,Gesichtsausdruck:proud<<";
    public const string EINTRITT_CHARAKTER_03_GESICHTSAUSDRUCK_SCARED = ">>Eintritt:Charakter03,Gesichtsausdruck:scared<<";
    public const string EINTRITT_CHARAKTER_03_GESICHTSAUSDRUCK_QUESTIONING = ">>Eintritt:Charakter03,Gesichtsausdruck:questioning<<";
    public const string EINTRITT_CHARAKTER_03_GESICHTSAUSDRUCK_DEFEATED = ">>Eintritt:Charakter03,Gesichtsausdruck:defeated<<";
    ...
    public const string CHARAKTER_SPRICHT_CHARAKTER_03_GESICHTSAUSDRUCK_ASTONISHED = ">>Charakter03SprichtAstonished:<<";
    public const string CHARAKTER_SPRICHT_CHARAKTER_03_GESICHTSAUSDRUCK_REFUSING = ">>Charakter03SprichtRefusing:<<";
    public const string CHARAKTER_SPRICHT_CHARAKTER_03_GESICHTSAUSDRUCK_SMILING = ">>Charakter03SprichtSmiling:<<";
    public const string CHARAKTER_SPRICHT_CHARAKTER_03_GESICHTSAUSDRUCK_FRIENDLY = ">>Charakter03SprichtFriendly:<<";
    public const string CHARAKTER_SPRICHT_CHARAKTER_03_GESICHTSAUSDRUCK_LAUGHING = ">>Charakter03SprichtLaughing:<<";
    public const string CHARAKTER_SPRICHT_CHARAKTER_03_GESICHTSAUSDRUCK_CRITICAL = ">>Charakter03SprichtCritical:<<";
    public const string CHARAKTER_SPRICHT_CHARAKTER_03_GESICHTSAUSDRUCK_DECISION_NO = ">>Charakter03SprichtDecisionNo:<<";
    ...
    public const string CHARAKTER_SPRICHT_CHARAKTER_03_GESICHTSAUSDRUCK_QUESTIONING = ">>Charakter03SprichtQuestioning:<<";
    public const string CHARAKTER_SPRICHT_CHARAKTER_03_GESICHTSAUSDRUCK_DEFEATED = ">>Charakter03SprichtDefeated:<<";
    ...
    public const string RELEVANTER_BIAS_BIAS_IN_DER_WAHRNEHMUNG_VON_FUEHRUNGSFAEHIGKEITEN = ">>RelevanterBias:BiasInDerWahrnehmungVonFuehrungsfaehigkeiten<<";
    public const string RELEVANTER_BIAS_RASSISTISCHE_UND_ETHNISCHE_BIASES = ">>RelevanterBias:RassistischeUndEthnischeBiases<<";
    public const string RELEVANTER_BIAS_SOZIOOEKONOMISCHE_BIASES = ">>RelevanterBias:SoziooekonomischeBiases<<";
    public const string RELEVANTER_BIAS_ALTER_UND_GENERATIONEN_BIASES = ">>RelevanterBias:AlterUndGenerationenBiases<<";
    public const string RELEVANTER_BIAS_SEXUALITAETSBEZOGENE_BIASES = ">>RelevanterBias:SexualitaetsbezogeneBiases<<";
    public const string RELEVANTER_BIAS_BIASES_GEGENUEBER_FRAUEN_MIT_BEHINDERUNGEN = ">>RelevanterBias:BiasesGegenueberFrauenMitBehinderungen<<";
    public const string RELEVANTER_BIAS_STEREOTYPE_GEGENUEBER_FRAUEN_IN_NICHT_TRADITIONELLEN_BRANCHEN = ">>RelevanterBias:StereotypeGegenueberFrauenInNichtTraditionellenBranchen<<";
    public const string RELEVANTER_BIAS_KULTURELLE_UND_RELIGIOESE_BIASES = ">>RelevanterBias:KulturelleUndReligioeseBiases<<";
    public const string RELEVANTER_BIAS_MATERNAL_BIAS = ">>RelevanterBias:MaternalBias<<";
    public const string RELEVANTER_BIAS_BIASES_GEGENUEBER_FRAUEN_MIT_KINDERN = ">>RelevanterBias:BiasesGegenueberFrauenMitKindern<<";
    public const string RELEVANTER_BIAS_ERWARTUNGSHALTUNG_BEZUEGLICH_FAMILIENPLANUNG = ">>RelevanterBias:ErwartungshaltungBezueglichFamilienplanung<<";
    public const string RELEVANTER_BIAS_WORK_LIFE_BALANCE_ERWARTUNGEN = ">>RelevanterBias:WorkLifeBalanceErwartungen<<";
    public const string RELEVANTER_BIAS_GESCHLECHTSSPEZIFISCHE_STEREOTYPEN = ">>RelevanterBias:GeschlechtsspezifischeStereotypen<<";
