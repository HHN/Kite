...
public class GNP_V01_JOB03 : PipelineJob
{
    public GNP_V01_JOB03()
    {
        this.jobName = "Job03 - Bestimmung der Rolle des Gesprächspartners.";
    }
    ...
    public override PipelineJobState HandleCompletion(string completion)
    {
        ...
        if (match.Success)
        {
            ...
            pipeline.GetMemory()[GenerateNovelPipeline.ROLE_OF_TALKING_PARTNER] = result;
    ...
    public override void InitializePrompt()
    {
        ...
        stringBuilder.AppendLine();
        stringBuilder.Append("Deine Aufgabe ist es, den Gesprächspartner der Hauptfigur für die Novel zu bestimmen, die du gerade erzeugst. Wer ist der Gesprächspartner? Weiter unten in diesem Prompt findest du die Beschreibung der Novel, sowie den Namen der Hauptfigur. Die Hauptfigur ist eine Gründerin. Die Rolle des Gesprächspartners oder der Gesprächspartnerin sollte aus der Beschreibung hervorgehen.");
        stringBuilder.AppendLine();
