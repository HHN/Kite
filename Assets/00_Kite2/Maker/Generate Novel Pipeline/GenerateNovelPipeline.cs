...
public class GenerateNovelPipeline : GPT_Pipeline
{
    ...
    public const string SPEAKER_31 = "speaker31";
    public const string MESSAGE_31 = "message31";
    public const string EXPRESSION_TYPE_31 = "expressionType31";
    public const string SPEAKER_32 = "speaker32";
    public const string MESSAGE_32 = "message32";
    public const string EXPRESSION_TYPE_32 = "expressionType32";
    public const string SPEAKER_33 = "speaker33";
    public const string MESSAGE_33 = "message33";
    public const string EXPRESSION_TYPE_33 = "expressionType33";
    public const string SPEAKER_34 = "speaker34";
    public const string MESSAGE_34 = "message34";
    public const string EXPRESSION_TYPE_34 = "expressionType34";
    public const string SPEAKER_35 = "speaker35";
    public const string MESSAGE_35 = "message35";
    public const string EXPRESSION_TYPE_35 = "expressionType35";
    public const string SPEAKER_36 = "speaker36";
    public const string MESSAGE_36 = "message36";
    public const string EXPRESSION_TYPE_36 = "expressionType36";
    public const string SPEAKER_37 = "speaker37";
    public const string MESSAGE_37 = "message37";
    public const string EXPRESSION_TYPE_37 = "expressionType37";
    public const string SPEAKER_38 = "speaker38";
    public const string MESSAGE_38 = "message38";
    public const string EXPRESSION_TYPE_38 = "expressionType38";
    ...
    public NovelFactory.NovelInformationWrapper CreateNovelInformationWrapper()
    {
        try
        {
            ...
            wrapper.speaker31 = this.memory[SPEAKER_31];
            wrapper.message31 = this.memory[MESSAGE_31];
            wrapper.expressionType31 = Int32.Parse(this.memory[EXPRESSION_TYPE_31]);
            wrapper.speaker32 = this.memory[SPEAKER_32];
            wrapper.message32 = this.memory[MESSAGE_32];
            wrapper.expressionType32 = Int32.Parse(this.memory[EXPRESSION_TYPE_32]);
            wrapper.speaker33 = this.memory[SPEAKER_33];
            wrapper.message33 = this.memory[MESSAGE_33];
            wrapper.expressionType33 = Int32.Parse(this.memory[EXPRESSION_TYPE_33]);
            wrapper.speaker34 = this.memory[SPEAKER_34];
            wrapper.message34 = this.memory[MESSAGE_34];
            wrapper.expressionType34 = Int32.Parse(this.memory[EXPRESSION_TYPE_34]);
            wrapper.speaker35 = this.memory[SPEAKER_35];
            wrapper.message35 = this.memory[MESSAGE_35];
            wrapper.expressionType35 = Int32.Parse(this.memory[EXPRESSION_TYPE_35]);
            wrapper.speaker36 = this.memory[SPEAKER_36];
            wrapper.message36 = this.memory[MESSAGE_36];
            wrapper.expressionType36 = Int32.Parse(this.memory[EXPRESSION_TYPE_36]);
            wrapper.speaker37 = this.memory[SPEAKER_37];
            wrapper.message37 = this.memory[MESSAGE_37];
            wrapper.expressionType37 = Int32.Parse(this.memory[EXPRESSION_TYPE_37]);
            wrapper.speaker38 = this.memory[SPEAKER_38];
            wrapper.message38 = this.memory[MESSAGE_38];
            wrapper.expressionType38 = Int32.Parse(this.memory[EXPRESSION_TYPE_38]);
