...
public class Job10_GenerateDialogOptionsFive : PipelineJob
{
    public Job10_GenerateDialogOptionsFive()
    {
        this.jobName = "Generate Dialog Option 05";
    }
    ...
    public override PipelineJobState HandleCompletion(string completion)
    {
        try
        {
            ...
            this.pipeline.GetMemory().Add(GenerateNovelPipeline.ALTERNATIVE_ANSWER_05_01, str1);
            this.pipeline.GetMemory().Add(GenerateNovelPipeline.ALTERNATIVE_ANSWER_05_02, str2);
            this.pipeline.GetMemory().Add(GenerateNovelPipeline.ALTERNATIVE_ANSWER_05_03, str3);
    ...
    public override void InitializePrompt()
    {
        ...
        string text01 = ((GenerateNovelPipeline)this.pipeline).idToValue[26];
        string text02 = ((GenerateNovelPipeline)this.pipeline).idToValue[27];
        string text03 = ((GenerateNovelPipeline)this.pipeline).idToValue[28];
