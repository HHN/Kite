...
public class GNP_V01_JOB16 : PipelineJob
{
    ...
    public override void InitializePrompt()
    {
        ...
        stringBuilder.AppendLine(this.pipeline.GetMemory()[GenerateNovelPipeline.NAME_OF_MAIN_CHARACTER] + ": " + this.pipeline.GetMemory()[GenerateNovelPipeline.MESSAGE_21_OPTION_01]);
        stringBuilder.AppendLine(this.pipeline.GetMemory()[GenerateNovelPipeline.SPEAKER_22] + ": " + this.pipeline.GetMemory()[GenerateNovelPipeline.MESSAGE_22]);
        stringBuilder.AppendLine(this.pipeline.GetMemory()[GenerateNovelPipeline.SPEAKER_23] + ": " + this.pipeline.GetMemory()[GenerateNovelPipeline.MESSAGE_23]);
        stringBuilder.AppendLine(this.pipeline.GetMemory()[GenerateNovelPipeline.SPEAKER_24] + ": " + this.pipeline.GetMemory()[GenerateNovelPipeline.MESSAGE_24]);
