...
public class GNP_V01_JOB02 : PipelineJob
{
    public GNP_V01_JOB02()
    {
        this.jobName = "Job02 - Generierung eines Namens für die Hauptfigur";
    }
    ...
    public override PipelineJobState HandleCompletion(string completion)
    {
        ...
        if (match.Success)
        {
            ...
            pipeline.GetMemory()[GenerateNovelPipeline.NAME_OF_MAIN_CHARACTER] = result;
    ...
    public override void InitializePrompt()
    {
        ...
        stringBuilder.AppendLine();
        stringBuilder.Append("Deine nächste Aufgabe besteht darin, für die Hauptfigur der Visual Novel, die du gerade erzeugst, einen Namen festzulegen. Diese Hauptfigur ist eine Gründerin. Bitte gib sowohl einen Vor- als auch einen Nachnamen für sie an. ");
        stringBuilder.AppendLine();
