...
public class GNP_V01_JOB12 : PipelineJob
{
    ...
    public override void InitializePrompt()
    {
        ...
        stringBuilder.AppendLine();
        stringBuilder.Append(pipeline.GetMemory()[GenerateNovelPipeline.NAME_OF_TALKING_PARTNER] + ": " + pipeline.GetMemory()[GenerateNovelPipeline.MESSAGE_03]);
        stringBuilder.Append(pipeline.GetMemory()[GenerateNovelPipeline.NAME_OF_MAIN_CHARACTER] + ": " + pipeline.GetMemory()[GenerateNovelPipeline.MESSAGE_04_OPTION_01]);
        ...
        stringBuilder.AppendLine();
        stringBuilder.Append(pipeline.GetMemory()[GenerateNovelPipeline.SPEAKER_01] + ": " + pipeline.GetMemory()[GenerateNovelPipeline.MESSAGE_01]);
        stringBuilder.Append(pipeline.GetMemory()[GenerateNovelPipeline.SPEAKER_02] + ": " + pipeline.GetMemory()[GenerateNovelPipeline.MESSAGE_02]);
        stringBuilder.Append(pipeline.GetMemory()[GenerateNovelPipeline.SPEAKER_03] + ": " + pipeline.GetMemory()[GenerateNovelPipeline.MESSAGE_03]);
        stringBuilder.Append(pipeline.GetMemory()[GenerateNovelPipeline.NAME_OF_MAIN_CHARACTER] + ": " + pipeline.GetMemory()[GenerateNovelPipeline.MESSAGE_04_OPTION_01]);
        stringBuilder.Append(pipeline.GetMemory()[GenerateNovelPipeline.SPEAKER_05] + ": " + pipeline.GetMemory()[GenerateNovelPipeline.MESSAGE_05]);
