...
public class GNP_V01_JOB47 : PipelineJob
{
    public GNP_V01_JOB47()
    {
        this.jobName = "Job47 - Gesichtsausdruck Nachricht";
    }
    ...
    public override void InitializePrompt()
    {
        ...
        stringBuilder.Append("Hier die fragliche Nachricht: " + pipeline.GetMemory()[GenerateNovelPipeline.MESSAGE_36]);
        stringBuilder.Append("Die Nachricht wurde gesprochen von: " + pipeline.GetMemory()[GenerateNovelPipeline.SPEAKER_36]);
        stringBuilder.AppendLine();
