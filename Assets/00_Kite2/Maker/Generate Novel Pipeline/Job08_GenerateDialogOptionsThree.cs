...
public class Job08_GenerateDialogOptionsThree : PipelineJob
{
    public Job08_GenerateDialogOptionsThree()
    {
        this.jobName = "Generate Dialog Option 03";
    }
    ...
    public override PipelineJobState HandleCompletion(string completion)
    {
        try
        {
            ...
            this.pipeline.GetMemory().Add(GenerateNovelPipeline.ALTERNATIVE_ANSWER_03_01, str1);
            this.pipeline.GetMemory().Add(GenerateNovelPipeline.ALTERNATIVE_ANSWER_03_02, str2);
            this.pipeline.GetMemory().Add(GenerateNovelPipeline.ALTERNATIVE_ANSWER_03_03, str3);
    ...
    public override void InitializePrompt()
    {
        ...
        string text01 = ((GenerateNovelPipeline)this.pipeline).idToValue[11];
        string text02 = ((GenerateNovelPipeline)this.pipeline).idToValue[12];
        string text03 = ((GenerateNovelPipeline)this.pipeline).idToValue[13];
