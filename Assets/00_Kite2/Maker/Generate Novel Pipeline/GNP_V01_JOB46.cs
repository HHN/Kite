...
public class GNP_V01_JOB46 : PipelineJob
{
    public GNP_V01_JOB46()
    {
        this.jobName = "Job46 - Gesichtsausdruck Nachricht";
    }
    ...
    public override PipelineJobState HandleCompletion(string completion)
    {
        ...
        if (match.Success)
        {
            ...
            if (parseable)
            {
                //pipeline.GetMemory()[GenerateNovelPipeline.EXPRESSION_TYPE_35] = result;
    ...
    public override void InitializePrompt()
    {
        ...
        stringBuilder.Append("Die Nachricht wurde gesprochen von: " + pipeline.GetMemory()[GenerateNovelPipeline.SPEAKER_35]);
        stringBuilder.AppendLine();
