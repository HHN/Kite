...
public class Job09_GenerateDialogOptionsFour : PipelineJob
{
    public Job09_GenerateDialogOptionsFour()
    {
        this.jobName = "Generate Dialog Option 04";
    }
    ...
    public override PipelineJobState HandleCompletion(string completion)
    {
        try
        {
            ...
            this.pipeline.GetMemory().Add(GenerateNovelPipeline.ALTERNATIVE_ANSWER_04_01, str1);
            this.pipeline.GetMemory().Add(GenerateNovelPipeline.ALTERNATIVE_ANSWER_04_02, str2);
            this.pipeline.GetMemory().Add(GenerateNovelPipeline.ALTERNATIVE_ANSWER_04_03, str3);
    ...
    public override void InitializePrompt()
    {
        ...
        string text01 = ((GenerateNovelPipeline)this.pipeline).idToValue[22];
        string text02 = ((GenerateNovelPipeline)this.pipeline).idToValue[23];
        string text03 = ((GenerateNovelPipeline)this.pipeline).idToValue[24];
