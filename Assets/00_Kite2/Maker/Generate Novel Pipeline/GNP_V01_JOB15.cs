...
public class GNP_V01_JOB15 : PipelineJob
{
    ...
    public override void InitializePrompt()
    {
        ...
        stringBuilder.AppendLine();
        stringBuilder.Append(pipeline.GetMemory()[GenerateNovelPipeline.NAME_OF_TALKING_PARTNER] + ": " + pipeline.GetMemory()[GenerateNovelPipeline.MESSAGE_20]);
        stringBuilder.Append(pipeline.GetMemory()[GenerateNovelPipeline.NAME_OF_MAIN_CHARACTER] + ": " + pipeline.GetMemory()[GenerateNovelPipeline.MESSAGE_21_OPTION_01]);
        stringBuilder.Append(pipeline.GetMemory()[GenerateNovelPipeline.NAME_OF_TALKING_PARTNER] + ": " + pipeline.GetMemory()[GenerateNovelPipeline.MESSAGE_22]);
        ...
        stringBuilder.AppendLine();
        stringBuilder.Append(pipeline.GetMemory()[GenerateNovelPipeline.SPEAKER_18] + ": " + pipeline.GetMemory()[GenerateNovelPipeline.MESSAGE_18]);
        stringBuilder.Append(pipeline.GetMemory()[GenerateNovelPipeline.SPEAKER_19] + ": " + pipeline.GetMemory()[GenerateNovelPipeline.MESSAGE_19]);
        stringBuilder.Append(pipeline.GetMemory()[GenerateNovelPipeline.SPEAKER_20] + ": " + pipeline.GetMemory()[GenerateNovelPipeline.MESSAGE_20]);
        stringBuilder.Append(pipeline.GetMemory()[GenerateNovelPipeline.NAME_OF_MAIN_CHARACTER] + ": " + pipeline.GetMemory()[GenerateNovelPipeline.MESSAGE_21_OPTION_01]);
        stringBuilder.Append(pipeline.GetMemory()[GenerateNovelPipeline.SPEAKER_22] + ": " + pipeline.GetMemory()[GenerateNovelPipeline.MESSAGE_22]);
        stringBuilder.Append(pipeline.GetMemory()[GenerateNovelPipeline.SPEAKER_23] + ": " + pipeline.GetMemory()[GenerateNovelPipeline.MESSAGE_23]);
        stringBuilder.Append(pipeline.GetMemory()[GenerateNovelPipeline.SPEAKER_24] + ": " + pipeline.GetMemory()[GenerateNovelPipeline.MESSAGE_24]);
