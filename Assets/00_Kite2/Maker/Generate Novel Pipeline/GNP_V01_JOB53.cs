...
public class GNP_V01_JOB53 : PipelineJob
{
    public GNP_V01_JOB53()
    {
        this.jobName = "Job53";
    }
    ...
    public override void InitializePrompt()
    {
        ...
        stringBuilder.AppendLine("{\"id\": \"25\", \"key\": \"" + this.pipeline.GetMemory()[GenerateNovelPipeline.NAME_OF_MAIN_CHARACTER] + "\", \"value\": \"" + this.pipeline.GetMemory()[GenerateNovelPipeline.MESSAGE_25_OPTION_04] + "\"},");
    ...
    public bool PutResultsIntoMemory(int id, string key, string value)
    {
        ...
        switch (id)
        {
            case 26:
                {
                    this.pipeline.GetMemory()[GenerateNovelPipeline.MESSAGE_26_ALTERNATIV_04] = value;
                    this.pipeline.GetMemory()[GenerateNovelPipeline.SPEAKER_26_ALTERNATIV_04] = key;
                    this.pipeline.GetMemory()[GenerateNovelPipeline.EXPRESSION_TYPE_26_ALTERNATIV_04] = defaultExpressionType;
                    return true;
                }
            case 27:
                {
                    this.pipeline.GetMemory()[GenerateNovelPipeline.MESSAGE_27_ALTERNATIV_04] = value;
                    this.pipeline.GetMemory()[GenerateNovelPipeline.SPEAKER_27_ALTERNATIV_04] = key;
                    this.pipeline.GetMemory()[GenerateNovelPipeline.EXPRESSION_TYPE_27_ALTERNATIV_04] = defaultExpressionType;
                    return true;
                }
            case 28:
                {
                    this.pipeline.GetMemory()[GenerateNovelPipeline.MESSAGE_28_ALTERNATIV_04] = value;
                    this.pipeline.GetMemory()[GenerateNovelPipeline.SPEAKER_28_ALTERNATIV_04] = key;
                    this.pipeline.GetMemory()[GenerateNovelPipeline.EXPRESSION_TYPE_28_ALTERNATIV_04] = defaultExpressionType;
                    return true;
                }
            case 29:
                {
                    this.pipeline.GetMemory()[GenerateNovelPipeline.MESSAGE_29_ALTERNATIV_04] = value;
                    this.pipeline.GetMemory()[GenerateNovelPipeline.SPEAKER_29_ALTERNATIV_04] = key;
                    this.pipeline.GetMemory()[GenerateNovelPipeline.EXPRESSION_TYPE_29_ALTERNATIV_04] = defaultExpressionType;
                    return true;
                }
            case 30:
                {
                    this.pipeline.GetMemory()[GenerateNovelPipeline.MESSAGE_30_ALTERNATIV_04] = value;
                    this.pipeline.GetMemory()[GenerateNovelPipeline.SPEAKER_30_ALTERNATIV_04] = key;
                    this.pipeline.GetMemory()[GenerateNovelPipeline.EXPRESSION_TYPE_30_ALTERNATIV_04] = defaultExpressionType;
                    return true;
                }
        }
        return false;
