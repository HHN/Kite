...
public class UAP_AccessibilityManager : MonoBehaviour
{
	...
	{
		Debug.Log("Say_Internal");
        Debug.Log(instance.m_AudioQueue);
		instance.m_AudioQueue.QueueAudio(textToSay, UAP_AudioQueue.EAudioType.App, allowVoiceOver, null, interrupts, canBeInterrupted);
	}
