public class InfoMessages
{
    ...
    public static readonly string EXPLANATION_COLLECT_DATA_BUTTON = "Aktuell werden von dir keine Nutzungsdaten aufgezeichnet. Um Die Kite II Mobile App verbessern zu können, möchten wir Daten über das Nutzungsverhalten der Nutzenden aufzeichnen. Durch die Analyse der Daten können wir vielleicht Verbesserungsmöglichkeiten identifizieren. Die Aufzeichnung der Daten ist anonym und erfolg freiwillig. Mit diesem Button Kannst du die Datenaufzeichnung starten.";
    public static readonly string EXPLANATION_STOP_DATA_BUTTON = "Aktuell werden von dir Nutzungsdaten aufgezeichnet. Um Die Kite II Mobile App verbessern zu können, möchten wir Daten über das Nutzungsverhalten der Nutzenden aufzeichnen. Durch die Analyse der Daten können wir vielleicht Verbesserungsmöglichkeiten identifizieren. Die Aufzeichnung der Daten ist anonym und erfolg freiwillig. Mit diesem Button Kannst du die Datenaufzeichnung stoppen.";
    public static readonly string EXPLANATION_DELETE_DATA_BUTTON = "Falls du dem zugestimmt hast, wurden Daten über dein Nutzungsverhalten anonym aufgezeichnet. Die aufgezeichenten Daten werden ausschließlich dazu genutzt um die Kite II Mobile App zu verbessern. Mit diesem Button kannst du alle über dich aufgezeichneten Daten löschen.";
