...
{
    public const string PLAYER = "Spielerin";
    public const string INTRO = "Intro";
    public const string OUTRO = "Outro";
    public const string INFO = "Info";
    public const string REPORTERIN = "Journalistin";
    public const string VERMIETER = "Vermieter";
    public const string VATER = "Vater";
    public const string MUTTER = "Mutter";
    public const string BEKANNTER = "Bekannter";
    public const string NOTARIN = "Notarin";
    public const string SACHBEARBEITER = "Sachbearbeiter";
    ...
    public static Character ValueOf(int i)
    {
        switch (i)
        {
            ...
            case 5: { return Character.REPORTERIN; }
            case 6: { return Character.VERMIETER; }
            case 7: { return Character.VATER; }
            case 8: { return Character.MUTTER; }
            case 9: { return Character.BEKANNTER; }
            case 10: { return Character.NOTARIN; }
            case 11: { return Character.SACHBEARBEITER; }
    ...
    public static string GetNameOfCharacter(Character character)
    {
        switch (character)
        {
            ...
            case Character.BEKANNTER: { return BEKANNTER; }
            case Character.NOTARIN: { return NOTARIN; }
            case Character.SACHBEARBEITER: { return SACHBEARBEITER; }
            default: { return null; }
        }
    }
    ...
    public static string GetNameOfCharacter(int i)
    {
        switch (i)
        {
            ...
            case 3: { return OUTRO; }
            case 4: { return INFO; }
            case 5: { return REPORTERIN; }
            case 6: { return VERMIETER; }
            case 7: { return VATER; }
            case 8: { return MUTTER; }
            case 9: { return BEKANNTER; }
            case 10: { return NOTARIN; }
            case 11: { return SACHBEARBEITER; }
            default: return null;
        }
    }
    ...
    public static Character ValueOf(string name)
    {
        switch (name)
        {
            ...
            case BEKANNTER: { return Character.BEKANNTER; }
            case NOTARIN: { return Character.NOTARIN; }
            case SACHBEARBEITER: { return Character.SACHBEARBEITER; }
            default: return Character.NONE;
        }
    }
}