...
public class PromptManager
{
    ...
    public void InitializePrompt()
    {
        ...
        prompt.AppendLine();
        //Output Format
        prompt.Append("Schreibe einen Analysetext. Stelle die Biases und Verzerrungen dar, auf die du dich beziehst (unten eine Liste mit Geschlechterbiases im Gründungsprozess). Richte den Text in der Du-Form an Lea. Sei wohlwollend und ermunternd. Sprich Lea nicht mit ihrem Namen an. Formuliere den Text aus einer unbestimmten Ich-Perspektive. ");
        prompt.AppendLine();
        //Wissens Basis
